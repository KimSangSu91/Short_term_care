            ...
            >
              ...
              <form 
                onSubmit={async (e) => {
                  ...
                  // status state would be better, but for a quick fix in this component:
                  ...
                  try {
                    ...
                    // Note: You need a Formspree ID to make this work. 
                    // I will use a placeholder that you can replace easily.
                    // For now, I will use dkfosk645@gmail.com directly as some services allow this, 
                    // but usually you need an ID like 'https://formspree.io/f/mqkvqoqz'
                    const response = await fetch('https://formspree.io/f/mqkvqoqz', { // Replace this ID with your actual Formspree ID
                      method: 'POST',
                      body: fd,
                      headers: {
                    ...
                    window.location.href = `mailto:dkfosk645@gmail.com?subject=${encodeURIComponent('잠깐돌봄 서비스 도입 문의')}&body=${encodeURIComponent(body)}`;
                    setIsModalOpen(false);
                  } finally {
